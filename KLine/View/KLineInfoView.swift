...
//        topBgView.backgroundColor = UIColor.black.withAlphaComponent(0.9)
    ...
    private lazy var openDescrLabel:UILabel = {
        let openDescrLabel = UILabel.create(text: "开", font: FontConst.DINAlternateBold(size: 10), color: UIColor(hexString: "#8E9AB5"))
        return openDescrLabel
    }()
    private lazy var openLabel:UILabel = {
        let openLabel = UILabel.create(text: nil, font: FontConst.DINAlternateBold(size: 10), color: KLineConst.kCandleRedColor)
        return openLabel
    }()
    /// 最高价
    private lazy var highDescrLabel:UILabel = {
        let highDescrLabel = UILabel.create(text: "高", font: FontConst.DINAlternateBold(size: 10), color: UIColor(hexString: "#8E9AB5"))
        return highDescrLabel
    }()
    private lazy var highLabel:UILabel = {
        let highLabel = UILabel.create(text: nil, font: FontConst.DINAlternateBold(size: 10), color: KLineConst.kCandleGreenColor)
        return highLabel
    }()
    /// 最低价
    private lazy var lowDescrLabel:UILabel = {
        let lowDescrLabel = UILabel.create(text: "低", font: FontConst.DINAlternateBold(size: 10), color: UIColor(hexString: "#8E9AB5"))
        return lowDescrLabel
    }()
    private lazy var lowLabel:UILabel = {
        let lowLabel = UILabel.create(text: nil, font: FontConst.DINAlternateBold(size: 10), color: KLineConst.kCandleRedColor)
        return lowLabel
    }()
    /// 收盘价
    private lazy var closeDescrLabel:UILabel = {
        let closeDescrLabel = UILabel.create(text: "收", font: FontConst.DINAlternateBold(size: 10), color: UIColor(hexString: "#8E9AB5"))
        return closeDescrLabel
    }()
    private lazy var closeLabel:UILabel = {
        let closeLabel = UILabel.create(text: nil, font: FontConst.DINAlternateBold(size: 10), color: KLineConst.kCandleRedColor)
        return closeLabel
    }()
    /// 涨跌幅
    private lazy var percentDescrLabel:UILabel = {
        let percentDescrLabel = UILabel.create(text: "幅", font: FontConst.DINAlternateBold(size: 10), color: UIColor(hexString: "#8E9AB5"))
        return percentDescrLabel
    }()
    private lazy var percentLabel:UILabel = {
        let percentLabel = UILabel.create(text: nil, font: FontConst.DINAlternateBold(size: 10), color: KLineConst.kCandleRedColor)
        return percentLabel
    }()
    
    /// 成交量
    private lazy var volumeDescrLabel:UILabel = {
        let volumeDescrLabel = UILabel.create(text: "额", font: FontConst.DINAlternateBold(size: 10), color: UIColor(hexString: "#8E9AB5"))
        return volumeDescrLabel
    }()
    private lazy var volumeLabel:UILabel = {
        let volumeLabel = UILabel.create(text: nil, font: FontConst.DINAlternateBold(size: 10), color: UIColor(hexString: "#8E9AB5"))
        return volumeLabel
    }()
    /// 日期
    private lazy var dateLabel:UILabel = {
        let dateLabel = UILabel.create(text: nil, font: FontConst.DINAlternateBold(size: 10), color: UIColor(hexString: "#8E9AB5"))
        return dateLabel
    }()
    
    /// 上指标详情
    private lazy var topIndexLabels:(UILabel,UILabel,UILabel) = {
        let indexLabel1 = UILabel.create(text: "nil", font: FontConst.DINAlternateBold(size: 10), color: UIColor(hexString: "#F4F4F6"))
        let indexLabel2 = UILabel.create(text: "nil", font: FontConst.DINAlternateBold(size: 10), color: UIColor(hexString: "#F4F4F6"))
        let indexLabel3 = UILabel.create(text: "nil", font: FontConst.DINAlternateBold(size: 10), color: UIColor(hexString: "#F4F4F6"))
    ...
    private lazy var bottomIndexLabel:UILabel = {
        let bottomIndexLabel = UILabel.create(text: "nil", font: FontConst.DINAlternateBold(size: 10), color: UIColor(hexString: "#F4F4F6"))
